#
#  Be sure to run `pod spec lint CreatePodTestLib.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.description  = <<-DESC
	A short description of CreatePodTestLib
                   DESC

  spec.homepage     = "https://viewlift.com/"
  ...
  spec.author             = { "Gaurav Vig" => "gaurav.vig@viewlift.com" }
  # Or just: spec.author    = "Gaurav Vig"
  # spec.authors            = { "Gaurav Vig" => "gaurav.vig@viewlift.com" }
  # spec.social_media_url   = "https://twitter.com/Gaurav Vig"
  ...
  spec.source       = { :git => "https://github.com/gauravvig/CreatePodTestLib.git", :tag => spec.version.to_s }
